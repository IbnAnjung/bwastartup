...
func (h *userHandler) Login(c *gin.Context) {
	...
	response := helper.APIResponse("Successfully Loggedin", http.StatusOK, "success", data)
	c.JSON(http.StatusOK, response)
...
func (h *userHandler) CheckEmail(c *gin.Context) {
	...
	if isEmailAvailable {
		...
		metaMessage = "Email haas beed registered"
	}
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	response := helper.APIResponse("Upload avatar is successfull", http.StatusOK, "success", data)
...
func (h *userHandler) FetchUser(c *gin.Context) {
	...
	userFormatted := user.FormatUser(currentUser, "")
	response := helper.APIResponse("Successfull fetch user", http.StatusOK, "success", userFormatted)
